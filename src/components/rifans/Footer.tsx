            ...
            <div className="relative bg-white/80 dark:bg-[#12031a]/80 backdrop-blur-xl rounded-[28px] p-8 border border-gold/20 shadow-xl flex flex-col items-center gap-6">
              ...
              <div className="flex flex-col items-center gap-3">
                <div className="flex items-center gap-3">
                  <img src={samaLogo} alt="البنك المركزي السعودي" className="h-10 w-10 object-contain" />
                  <img src={cmaLogo} alt="هيئة السوق المالية" className="h-10 w-10 object-contain" />
                </div>
