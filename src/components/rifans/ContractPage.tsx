            ...
            <section>
              ...
              <p>
                 {isRescheduling
                   ...
                   : isSeizedAmounts
                   ? 'لا تستحق أتعاب الطرف الأول إلا بعد صدور قرار إتاحة النسبة النظامية واسترداد المبالغ المستثناه من الحجز. وفي حال صدور القرار، يستحق الطرف الأول أتعاباً مقطوعة قدرها (1%) من إجمالي المبالغ المستردة فعلياً. وفي حال عدم قبول الطلب، لا يحق للطرف الأول المطالبة بأي أتعاب.'
