    ...
    <div className="max-w-[520px] mx-auto px-4 py-8">
      ...
      <div className="text-right mb-3">
        ...
        <p className="text-sm font-bold text-gold mt-1 leading-relaxed">
          شركة سعودية ذات مسؤولية محدودة ، تعمل تحت مظلة قطاع التقنية المالية ( FinTech )
        </p>
      </div>
      ...
      <div className={`space-y-4 text-[13px] leading-[1.9] text-muted dark:text-gray-300 transition-colors ${direction === 'rtl' ? 'text-right' : 'text-left'}`}>
        <p>
          مرخصة من قِبل البنك المركزي السعودي وخاضعة لإشراف ورقابة هيئة السوق المالية ، متخصصة في تقديم الحلول والإستشارات المالية والعقارية وتقديم خدمات إنترنت الأشياء للأنشطة المالية وأنشطة التأمين والنشاطات الأخرى المساعدة لأنشطة الخدمات المالية
        </p>
        <p>
