            ...
            <div className="flex items-start justify-between" dir="ltr">
              ...
              <div className="flex items-center gap-2" dir="rtl">
                <div className="text-right">
                  <div className="text-[8px] font-[800] text-[#C7A969] leading-none tracking-wide">ريفانس المالية</div>
                  <div className="text-[5px] font-bold text-[#C7A969]/60 tracking-[0.3em] uppercase mt-0.5">RIFANIS FINANCE</div>
                </div>
            ...
            <div className="flex flex-col gap-[6%] mt-auto" dir="rtl">
              ...
              <div className="flex items-center gap-[4%]">
                ...
                <div className="flex-1 border border-[#C7A969]/40 rounded-[4px] px-[5px] py-[2px]">
                  <div className="text-[4px] font-[400] text-[#C7A969] text-right leading-tight">{data.name}</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-[4%]">
                ...
                <div className="flex-1 border border-[#C7A969]/40 rounded-[4px] px-[5px] py-[2px]">
                  <div className="text-[4px] font-[400] text-[#C7A969] font-mono tracking-wide text-right leading-tight">{data.file}</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-[4%]">
                ...
                <div className="flex-1 border border-[#C7A969]/40 rounded-[4px] px-[5px] py-[2px]">
                  <div className="text-[4px] font-[400] text-[#C7A969] font-mono tracking-wide text-right leading-tight">{data.id}</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-[4%]">
                ...
                <div className="flex-1 border border-[#C7A969]/40 rounded-[4px] px-[5px] py-[2px]">
                  <div className="text-[4px] font-[400] text-[#C7A969] font-mono tracking-wide text-right leading-tight">{data.mobile}</div>
                </div>
              </div>
            </div>
          </div>
