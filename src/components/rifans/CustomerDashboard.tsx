        ...
        <div className="flex-1 overflow-y-auto px-4 pb-8 custom-scrollbar">
           ...
           {activeTab === 'profile' && (
             <div className="space-y-4 pb-10">
                ...
                {/* Client Card */}
                <div className="mb-6">
                  <div ref={cardSaveRef} className="relative w-full aspect-[1.75/1] rounded-[16px] overflow-hidden shadow-[0_10px_40px_rgba(0,0,0,0.45)]" dir="rtl">
                    {/* Background */}
                    ...
                    <div className="absolute inset-0 flex flex-col justify-between p-[14px] z-10">
                      ...
                      {/* Data Fields - right side with good spacing */}
                      <div className="flex flex-col justify-end gap-[8px] w-[60%] mr-0 ml-auto mt-auto">
                        <div className="text-right">
                          <div className="text-[9px] text-[#C7A969]/70 mb-[2px]">الاسم / Name</div>
                          <div className="text-[11px] font-[700] text-[#C7A969] leading-tight">{userData.fullName || '---'}</div>
                        </div>
                        <div className="text-right">
                          <div className="text-[9px] text-[#C7A969]/70 mb-[2px]">رقم الملف / File No</div>
                          <div className="text-[11px] font-[700] text-[#C7A969] font-mono tracking-wide leading-tight">{userData.fileNumber || 'RF-0000-0000'}</div>
                        </div>
                        <div className="text-right">
                          <div className="text-[9px] text-[#C7A969]/70 mb-[2px]">رقم الهوية / ID</div>
                          <div className="text-[11px] font-[700] text-[#C7A969] font-mono tracking-wide leading-tight">{userData.nationalId || '---'}</div>
                        </div>
                        <div className="text-right">
                          <div className="text-[9px] text-[#C7A969]/70 mb-[2px]">رقم الجوال / Mobile No</div>
                          <div className="text-[11px] font-[700] text-[#C7A969] font-mono tracking-wide leading-tight">{userData.mobile || '---'}</div>
                        </div>
                      </div>
                    </div>
                  </div>
